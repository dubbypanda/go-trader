...
func TestPlaceManualProtectionInline_TPErrorsSurface(t *testing.T) {
	...
	runHLSyncProtectionFn = func(script, symbol, side string, size, avgCost, entryATR, stopLossATRMult float64, tiers []hlProtectionTier, stopLossOID int64, tpOIDs []int64, _ []bool, _ bool, _ []bool, _ []byte) (*HyperliquidProtectionSyncResult, string, error) {
